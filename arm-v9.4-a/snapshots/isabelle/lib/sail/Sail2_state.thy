...
fun  iterS_aux  :: \<open> int \<Rightarrow>(int \<Rightarrow> 'a \<Rightarrow> 'rv sequential_state \<Rightarrow>(((unit),'e)state_result*'rv sequential_state)set)\<Rightarrow> 'a list \<Rightarrow>('rv,(unit),'e)monadS \<close>  where 
     \<open> iterS_aux i f (x # xs) = ( seqS (f i x) (iterS_aux (i +( 1 :: int)) f xs))\<close> 
  for  "i"  :: " int " 
  and  "f"  :: " int \<Rightarrow> 'a \<Rightarrow> 'rv sequential_state \<Rightarrow>(((unit),'e)state_result*'rv sequential_state)set " 
  and  "xs"  :: " 'a list " 
  and  "x"  :: " 'a "
...
definition iteriS  :: \<open>(int \<Rightarrow> 'a \<Rightarrow>('rv,(unit),'e)monadS)\<Rightarrow> 'a list \<Rightarrow> 'rv sequential_state \<Rightarrow>(((unit),'e)state_result*'rv sequential_state)set \<close>  where 
...
definition iterS  :: \<open>('a \<Rightarrow> 'rv sequential_state \<Rightarrow>(((unit),'e)state_result*'rv sequential_state)set)\<Rightarrow> 'a list \<Rightarrow> 'rv sequential_state \<Rightarrow>(((unit),'e)state_result*'rv sequential_state)set \<close>  where 
     \<open> iterS f xs = ( iteriS ( (\<lambda>x .  
  (case  x of _ => (\<lambda> x .  f x) ))) xs )\<close> 
  for  "f"  :: " 'a \<Rightarrow> 'rv sequential_state \<Rightarrow>(((unit),'e)state_result*'rv sequential_state)set " 
  and  "xs"  :: " 'a list "


\<comment> \<open>\<open>val foreachS : forall 'a 'rv 'vars 'e.
  list 'a -> 'vars -> ('a -> 'vars -> monadS 'rv 'vars 'e) -> monadS 'rv 'vars 'e\<close>\<close>
fun  foreachS  :: \<open> 'a list \<Rightarrow> 'vars \<Rightarrow>('a \<Rightarrow> 'vars \<Rightarrow> 'rv sequential_state \<Rightarrow>(('vars,'e)state_result*'rv sequential_state)set)\<Rightarrow> 'rv sequential_state \<Rightarrow>(('vars,'e)state_result*'rv sequential_state)set \<close>  where 
     \<open> foreachS ([]) vars body = ( returnS vars )\<close> 
  for  "vars"  :: " 'vars " 
  and  "body"  :: " 'a \<Rightarrow> 'vars \<Rightarrow> 'rv sequential_state \<Rightarrow>(('vars,'e)state_result*'rv sequential_state)set "
...
definition genlistS  :: \<open>(nat \<Rightarrow> 'rv sequential_state \<Rightarrow>(('a,'e)state_result*'rv sequential_state)set)\<Rightarrow> nat \<Rightarrow> 'rv sequential_state \<Rightarrow>((('a list),'e)state_result*'rv sequential_state)set \<close>  where 
     \<open> genlistS f n = (
  (let indices = (genlist ((\<lambda> n .  n)) n) in
  foreachS indices [] ((\<lambda> n xs .  ( bindS(f n) ((\<lambda> x .  returnS (xs @ [x]))))))))\<close> 
  for  "f"  :: " nat \<Rightarrow> 'rv sequential_state \<Rightarrow>(('a,'e)state_result*'rv sequential_state)set " 
  and  "n"  :: " nat "


\<comment> \<open>\<open>val and_boolS : forall 'rv 'e. monadS 'rv bool 'e -> monadS 'rv bool 'e -> monadS 'rv bool 'e\<close>\<close>
definition and_boolS  :: \<open>('rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set)\<Rightarrow>('rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set)\<Rightarrow>('rv,(bool),'e)monadS \<close>  where 
     \<open> and_boolS l r = ( bindS l ((\<lambda> l .  if l then r else returnS False)))\<close> 
  for  "l"  :: " 'rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set " 
  and  "r"  :: " 'rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set "


\<comment> \<open>\<open>val or_boolS : forall 'rv 'e. monadS 'rv bool 'e -> monadS 'rv bool 'e -> monadS 'rv bool 'e\<close>\<close>
definition or_boolS  :: \<open>('rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set)\<Rightarrow>('rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set)\<Rightarrow>('rv,(bool),'e)monadS \<close>  where 
...
definition bool_of_bitU_fail  :: \<open> bitU \<Rightarrow> 'rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set \<close>  where 
...
definition bool_of_bitU_nondetS  :: \<open> bitU \<Rightarrow> 'rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set \<close>  where 
...
definition bools_of_bits_nondetS  :: \<open>(bitU)list \<Rightarrow> 'rv sequential_state \<Rightarrow>((((bool)list),'e)state_result*'rv sequential_state)set \<close>  where 
...
definition of_bits_failS  :: \<open> 'a Bitvector_class \<Rightarrow>(bitU)list \<Rightarrow> 'rv sequential_state \<Rightarrow>(('a,'e)state_result*'rv sequential_state)set \<close>  where 
...
function (sequential,domintros)  whileS  :: \<open> 'vars \<Rightarrow>('vars \<Rightarrow> 'rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set)\<Rightarrow>('vars \<Rightarrow> 'rv sequential_state \<Rightarrow>(('vars,'e)state_result*'rv sequential_state)set)\<Rightarrow> 'rv sequential_state \<Rightarrow>(('vars,'e)state_result*'rv sequential_state)set \<close>  where 
  ...
  for  "vars"  :: " 'vars " 
  and  "cond"  :: " 'vars \<Rightarrow> 'rv sequential_state \<Rightarrow>(((bool),'e)state_result*'rv sequential_state)set " 
  and  "body"  :: " 'vars \<Rightarrow> 'rv sequential_state \<Rightarrow>(('vars,'e)state_result*'rv sequential_state)set " 
...
definition choose_boolsS  :: \<open> nat \<Rightarrow> 'rv sequential_state \<Rightarrow>((((bool)list),'e)state_result*'rv sequential_state)set \<close>  where 
