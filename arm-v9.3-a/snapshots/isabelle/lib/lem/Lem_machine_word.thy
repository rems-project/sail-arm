...
\<comment> \<open>\<open>open import {isabelle} `Lem` `HOL-Library.Word` `Word_Lib.Generic_set_bit` `Word_Lib.Reversed_Bit_Lists` `Word_Lib.Signed_Division_Word`\<close>\<close>
