...
${EMULATOR} -b 0x80000000,bootloader.bin -b 0x81000000,sail.dtb -b 0x82080000,Image -C cpu.cpu0.RVBAR=0x80000000 -C cpu.has_tlb=0x0 -C emulator.termination_opcode=0xfee1dead 2> /dev/null || true
