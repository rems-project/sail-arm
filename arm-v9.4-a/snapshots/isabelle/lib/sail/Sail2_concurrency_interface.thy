...
\<comment> \<open>\<open> This is the type for read requests as Sail would generate, using
   ...
   Isabelle/HOL \<close>\<close>

record (overloaded)( 'vasize, 'pa, 'ts, 'arch_ak) Mem_read_request =
  
 Mem_read_request_access_kind ::" ( 'arch_ak Access_kind)" 

     Mem_read_request_va ::"  (( 'vasize::len)Word.word)option " 
...
record( 'pa, 'ts, 'arch_ak) Mem_read_request_bl =
  
 Mem_read_request_bl_access_kind ::" ( 'arch_ak Access_kind)" 

     Mem_read_request_bl_va ::"  ( bitU list)option " 

     Mem_read_request_bl_pa ::" 'pa " 

     Mem_read_request_bl_translation ::" 'ts " 

     Mem_read_request_bl_size ::" int " 

     Mem_read_request_bl_tag ::" bool "  


\<comment> \<open>\<open>val mem_read_request_to_bl : forall  'vasize 'pa 'ts 'arch_ak. Size 'vasize => Mem_read_request  'vasize 'pa 'ts 'arch_ak -> Mem_read_request_bl 'pa 'ts 'arch_ak\<close>\<close>
definition mem_read_request_to_bl  :: \<open>(('vasize::len),'pa,'ts,'arch_ak)Mem_read_request \<Rightarrow>('pa,'ts,'arch_ak)Mem_read_request_bl \<close>  where 
     \<open> mem_read_request_to_bl req = (
  (| Mem_read_request_bl_access_kind = ((Mem_read_request_access_kind   req)),
     Mem_read_request_bl_va = (map_option ((\<lambda> v. List.map bitU_of_bool (to_bl v)))(Mem_read_request_va   req)),
     Mem_read_request_bl_pa = ((Mem_read_request_pa   req)),
     Mem_read_request_bl_translation = ((Mem_read_request_translation   req)),
     Mem_read_request_bl_size = ((Mem_read_request_size   req)),
     Mem_read_request_bl_tag = ((Mem_read_request_tag   req))  |) )\<close> 
  for  "req"  :: "(('vasize::len),'pa,'ts,'arch_ak)Mem_read_request "


\<comment> \<open>\<open> Similarly, we have machine word and bitlist versions of write requests. \<close>\<close>

record (overloaded)( 'vasize, 'pa, 'ts, 'arch_ak, 'p8_times_n) Mem_write_request =
  
 Mem_write_request_access_kind ::" 'arch_ak Access_kind " 

     Mem_write_request_va ::"  (( 'vasize::len)Word.word)option " 
     ...
     Mem_write_request_value ::"  (( 'p8_times_n::len)Word.word)option " 

     Mem_write_request_tag ::"  bool option "  


record( 'pa, 'ts, 'arch_ak) Mem_write_request_bl =
  
 Mem_write_request_bl_access_kind ::" ( 'arch_ak Access_kind)" 

     Mem_write_request_bl_va ::"  ( bitU list)option " 

     Mem_write_request_bl_pa ::" 'pa " 

     Mem_write_request_bl_translation ::" 'ts " 

     Mem_write_request_bl_size ::" int " 

     Mem_write_request_bl_value ::"  ( bitU list)option " 

     Mem_write_request_bl_tag ::"  bool option "  


\<comment> \<open>\<open>val mem_write_request_to_bl : forall  'vasize 'pa 'ts 'arch_ak 'p8_times_n. Size 'vasize, Size 'p8_times_n => Mem_write_request 'vasize 'pa 'ts 'arch_ak 'p8_times_n -> Mem_write_request_bl 'pa 'ts 'arch_ak\<close>\<close>
definition mem_write_request_to_bl  :: \<open>(('vasize::len),'pa,'ts,'arch_ak,('p8_times_n::len))Mem_write_request \<Rightarrow>('pa,'ts,'arch_ak)Mem_write_request_bl \<close>  where 
     \<open> mem_write_request_to_bl req = (
  (| Mem_write_request_bl_access_kind = ((Mem_write_request_access_kind   req)),
     Mem_write_request_bl_va = (map_option ((\<lambda> v. List.map bitU_of_bool (to_bl v)))(Mem_write_request_va   req)),
     Mem_write_request_bl_pa = ((Mem_write_request_pa   req)),
     Mem_write_request_bl_translation = ((Mem_write_request_translation   req)),
     Mem_write_request_bl_size = ((Mem_write_request_size   req)),
     Mem_write_request_bl_value = (map_option ((\<lambda> v. List.map bitU_of_bool (to_bl v)))(Mem_write_request_value   req)),
     Mem_write_request_bl_tag = ((Mem_write_request_tag   req))  |) )\<close> 
  for  "req"  :: "(('vasize::len),'pa,'ts,'arch_ak,('p8_times_n::len))Mem_write_request "
...
datatype( 'abort, 'barrier, 'cache_op, 'fault, 'pa, 'tlb_op, 'translation_summary, 'arch_ak, 'regval, 'a, 'e) monad =
  ...
  | Mem_read_request " ('pa, 'translation_summary, 'arch_ak) Mem_read_request_bl " " ( (( bitU list *  bool option), 'abort)result \<Rightarrow> ('abort, 'barrier, 'cache_op, 'fault, 'pa, 'tlb_op, 'translation_summary, 'arch_ak, 'regval, 'a, 'e) monad)"
  | Mem_write_request " ('pa, 'translation_summary, 'arch_ak) Mem_write_request_bl " " ( (( bool option), 'abort)result \<Rightarrow> ('abort, 'barrier, 'cache_op, 'fault, 'pa, 'tlb_op, 'translation_summary, 'arch_ak, 'regval, 'a, 'e) monad)"
...
datatype( 'abort, 'barrier, 'cache_op, 'fault, 'pa, 'tlb_op, 'translation_summary, 'arch_ak, 'regval) event =
  ...
  | E_mem_read_request " ('pa, 'translation_summary, 'arch_ak) Mem_read_request_bl " " (( bitU list *  bool option), 'abort) result "
  | E_mem_write_request " ('pa, 'translation_summary, 'arch_ak) Mem_write_request_bl " " (( bool option), 'abort) result "
...
|\<open> bind (Mem_read_request req k) f = ( Mem_read_request req ((\<lambda> v .  bind (k v) f)))\<close> 
  for  "req"  :: "('pa,'translation_summary,'arch_ak)Mem_read_request_bl " 
...
|\<open> bind (Mem_write_request req k) f = ( Mem_write_request req ((\<lambda> v .  bind (k v) f)))\<close> 
  for  "req"  :: "('pa,'translation_summary,'arch_ak)Mem_write_request_bl " 
...
\<comment> \<open>\<open>val sail_mem_read : forall 'vasize 'abort 'barrier 'cache_op 'fault 'pa 'tlb_op 'translation_summary 'arch_ak 'regval 'bv 'e. Size 'vasize, Bitvector 'bv =>
...
definition sail_mem_read  :: \<open> 'bv Bitvector_class \<Rightarrow>(('vasize::len),'pa,'translation_summary,'arch_ak)Mem_read_request \<Rightarrow>('abort,'barrier,'cache_op,'fault,'pa,'tlb_op,'translation_summary,'arch_ak,'regval,((('bv*(bool)option),'abort)result),'e)monad \<close>  where 
  ...
  Mem_read_request (mem_read_request_to_bl req) k))\<close> 
  for  "dict_Sail2_values_Bitvector_bv"  :: " 'bv Bitvector_class " 
  and  "req"  :: "(('vasize::len),'pa,'translation_summary,'arch_ak)Mem_read_request "


\<comment> \<open>\<open>val sail_mem_write : forall 'vasize 'valuesize 'abort 'barrier 'cache_op 'fault 'pa 'tlb_op 'translation_summary 'arch_ak 'regval 'e. Size 'vasize, Size 'valuesize =>
...
definition sail_mem_write  :: \<open>(('vasize::len),'pa,'translation_summary,'arch_ak,('valuesize::len))Mem_write_request \<Rightarrow>('abort,'barrier,'cache_op,'fault,'pa,'tlb_op,'translation_summary,'arch_ak,'regval,((((bool)option),'abort)result),'e)monad \<close>  where 
     \<open> sail_mem_write req = ( Mem_write_request (mem_write_request_to_bl req) return )\<close> 
  for  "req"  :: "(('vasize::len),'pa,'translation_summary,'arch_ak,('valuesize::len))Mem_write_request "
...
\<comment> \<open>\<open>val sail_cache_op : forall 'abort 'barrier 'cache_op 'fault 'pa 'tlb_op 'translation_summary 'arch_ak 'regval 'e.
  'cache_op ->
  monad 'abort 'barrier 'cache_op 'fault 'pa 'tlb_op 'translation_summary 'arch_ak 'regval unit 'e\<close>\<close>
definition sail_cache_op  :: \<open> 'cache_op \<Rightarrow>('abort,'barrier,'cache_op,'fault,'pa,'tlb_op,'translation_summary,'arch_ak,'regval,(unit),'e)monad \<close>  where 
     \<open> sail_cache_op cache_op = ( Cache_op_request cache_op (return () ))\<close> 
